<fieldset id="experience_fieldset">
    <div class="form-card">
        ...
        <div class="container border mb-3 p-3">
            ...
            <div class="row mt-2" id="designation_row">
        ...
        <div class="container border mb-3 p-3">
            <div class="row form-group">
                    <div class="col-md-6">
                        <label for="exampleInputCity1" class="c-text">Prior Experience of acting as Advisor/Expert in Interview Board (s)/Question paper setter/ Objective Item writer/ Moderator/ Examiner/ Evaluator/ Syllabus Framing?<span class="text-danger">*</span></label>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check d-flex">
                            <input type="radio" name="isprior" value="Yes"/>
                            <label class="ms-2" for="flexRadioDefault1">Yes </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check d-flex">
                            <input type="radio" name="isprior" value="No"/>
                            <label class="ms-2" for="flexRadioDefault1"> No </label>
                        </div>
                    </div>
                    <span class="text-danger" id="valid_isprior"></span>
                </div>
            <h4 class="mb-3">
                
            </h4>
            <div class="d-none" id="organization_details">
                <div class="row">
