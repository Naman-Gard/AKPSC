                    ...
                    <div class="preview-form">
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td scope="col" class="text-center w-50"><img src="{{public_path('assets/uploads/images/'.$data['upload']['image'])}}" width="120" height="120" alt="photo"></td>
                                        <td scope="col" class="text-center w-50"><img src="{{public_path('assets/uploads/signature/'.$data['upload']['signature'])}}" alt="signature" width="60" height="60"></td>
                                    </tr>
                                    <tr>
                                        <th>Name :</th>
                                        <td>
