...
<section class="heading mt-5 py-5">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="preview-form">
                                ...
                                <tr>
                                    ...
                                    <td rowspan="7">
                                        <div class="img-wrap text-center d-flex flex-column">
                                            <div class="img1 mb-4">
                                                <img src="{{asset('assets/uploads/images/'.$data['upload']['image'])}}"
                                                    width="140" height="140" alt="photo">
                                            </div>
                                            <div class="img2">
                                                <img src="{{asset('assets/uploads/signature/'.$data['upload']['signature'])}}"
                                                    alt="signature" width="100" height="60">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                    ...
                    <div class="declaration mt-4">
                        ...
                        <div class="d-flex">
                            ...
                            <p>I hereby certify that the information furnished in this form is true to best of my
                                knowledge.</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-end mt-3">
                        <img src="{{asset('assets/uploads/signature/'.$data['upload']['signature'])}}" class="me-4"
                            alt="signature" width="60" height="60">
                    </div>
                    <div class="btn-sec mb-5 d-flex justify-content-center mt-5">
                        <button type="submit" class="btn btn-custom mx-2" id="edit-form">Edit Form <img
                                src="{{asset('assets/preview/images/edit.svg')}}" height="24" alt=""></button>
                        <button type="submit" class="btn btn-custom mx-2" id="final-submit">Final Submit <img
                                src="{{asset('assets/preview/images/tick-box.gif')}}" height="24" alt=""></button>
                    </div>
                </div>
            </div>
        </div>
